                ...
                <table className="table table-hover">
                    ...
                    <tbody>
                        <tr ng-repeat="x in students">
                            ...
                            <td className="col-md-1">11 x.FACULTET 22, 11 x.COURSE 22, <a href="https://www.nstu.ru/studies/schedule/schedule_classes/schedule?group=11x.STUDY_GROUP22" target="_blank">11 x.STUDY_GROUP 22</a></td>
                            <td className="col-md-2">11 x.FIO 22</td>
                            <td className="col-md-1">11 x.SEX 22</td>
                            <td className="col-md-1">11 x.STATUS 22</td>
                            <td className="col-md-1"><a href="/" editable-checkbox="x.WAS" e-title="Был?" onbeforesave="updateWas($data,x.FK_STUDENT)">11 x.WAS == 1 && "Был" || x.WAS == 0 && "Не был" || "Проставить" 22</a></td>
